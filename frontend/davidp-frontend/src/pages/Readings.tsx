...
<Page title="Readings">
	...
	<ul>
		<li>
			<InnerBoxLinkDesc href="/page/fun/natethesnake" urlText="&quot;Nate The Snake&quot;">
				<>This is a long read, like 1-2 hours. Great story and hilarious ending I highly recommend.</>
			</InnerBoxLinkDesc>
		</li>

		<li>
			<InnerBoxLinkDesc href="/page/fun/backyardcarnival" urlText="&quot;Backyard Carnival of Death&quot;">
				<>A classic. Like 5-10 minutes read.</>
			</InnerBoxLinkDesc>
		</li>
		<li>
			<InnerBoxLinkDesc href="/page/fun/regex_parse_html" urlText="&quot;RegEx match open tags except XHTML self-contained tags&quot;">
				<>Quick read. You dare not parse HTML with regex...</>
			</InnerBoxLinkDesc>
		</li>
		<li>
			<InnerBoxLinkDesc href="/page/fun/python_dictionaries" urlText="&quot;Dictionary in Python&quot;">
