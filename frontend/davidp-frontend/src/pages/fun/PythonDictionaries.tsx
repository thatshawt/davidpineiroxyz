...
export default function DictionaryinPythonPage(){
	return (
<Page title="Dictionary in Python">
    <h1><i>"Dictionary in Python"</i></h1>

    <details>
        <summary>Lore</summary>
        <p>Original: <Link href="https://mail.python.org/pipermail/python-list/2000-March/048085.html">https://mail.python.org/pipermail/python-list/2000-March/048085.html</Link></p>
    <p>Date: Mon Mar 13 21:02:23 EST 2000</p>
    </details>

    <p><h3>"Alex asks"</h3>
        <code>...
    I'm going to have a look at how python decides to resize the hash table.</code>
    </p>

    <p><h3>"Tim answers"</h3>
        <code>{`A hash table is a contiguous vector of records, whose slots come in three
flavors:
