...
return (<Page title="Web THINGSIES">
    ...
    {/* <fieldset>
    <legend><h2>testtestts</h2></legend>
    other stutf i suppose
    </fieldset> */}

    <fieldset className='white-box'>
        <legend><h2>Helpful Tools & Inspiration</h2></legend>
    ...
    <fieldset className='white-box' id="webrings">
        <legend><h2>Web Rings and Ads</h2></legend>
        <div className="flex-container">
